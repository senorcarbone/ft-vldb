...
\affaddr{\textsuperscript{$\dagger$}KTH Royal Institute of Technology} \\ \affaddr{\{parisc,haridi\}@kth.se} & \affaddr{\textsuperscript{$\star$}King Digital Entertainment plc} \\ \affaddr{gyula.fora@king.com} & \affaddr{\textsuperscript{$\ddagger$}dataArtisans gmbh} \\ \affaddr{\{stephan,kostas,s.richter\} \\@data-artisans.com}
\end{tabular}
}
\vspace{-5mm}
