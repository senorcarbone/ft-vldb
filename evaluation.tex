...
Flink is widely used for continuous data analytics in the industry, serving as a the core engine for various small and large-scale data pipeline needs\paris{cite something} (e.g., King, Zalando, Uber, Netflix, ING, Bouygues Telecom, ING, New Relic, MediaMath and New Relic among others). In this section, we present a few examples of how Flink's state management features are being used in practice, within large deployments and also present live metrics and insights.
